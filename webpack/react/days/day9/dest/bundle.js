	...
	var SearchBar = _react2.default.createClass({
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            'form',
	            null,
	            _react2.default.createElement('input', { type: 'text', ref: 'filterTextInput', placeholder: 'searching.....', value: this.props.filterText, onChange: this.handleChange }),
	            _react2.default.createElement(
	                'p',
	                null,
	                _react2.default.createElement('input', { type: 'checkbox', ref: 'inStockOnlyInput', checked: this.props.inStockOnly }),
	                ' ',
