...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var CommentBox = _react2.default.createClass({
	    ...
	    loadData: function loadData() {
	        ...
	        _jquery2.default.ajax({
	            ...
	            success: function success(data) {
	                console.log(data);
	                _this.setState({ data: data[0] }); //更新状态
	            },
	    ...
	    handleCommentSubmit: function handleCommentSubmit(comment) {
	        ...
	        _jquery2.default.ajax({
	            ...
	            success: function success(data) {
	                console.log(data);
	                _this2.setState({ data: data[0] }); //更新状态
	            },
	            error: function error(xhr, status, err) {
	...
	_reactDom2.default.render(_react2.default.createElement(CommentBox, { url: 'http://localhost:9999/getdata', pollInterval: 2000 }), document.getElementById('content'));
	//***********************************************************************//
